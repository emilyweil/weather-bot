  ...
  <head>
    ...
    <style>
      *, *::before, *::after { margin: 0; padding: 0; box-sizing: border-box; }
      ...
      .bg-image { position: absolute; top: 0; left: 0; height: 100%; width: auto; min-width: 200%; object-fit: cover; animation: pan 120s linear infinite; filter: saturate(0.85) brightness(0.72); }
